    ...
    <div className="pb-24 md:pb-8 bg-white min-h-screen">
      ...
      <div className="px-4 py-2.5">
        ...
        <div className="bg-white rounded-lg border border-neutral-200 overflow-hidden divide-y divide-neutral-100">
          ...
          <button onClick={() => navigate('/refer-earn')} className="w-full flex items-center justify-between px-3 py-3 hover:bg-neutral-50 transition-colors">
            <div className="flex items-center gap-3">
              <span className="text-lg leading-none">🎁</span>
              <span className="text-[13px] font-medium text-neutral-900">Refer & Earn</span>
            </div>
            <span className="text-xs font-bold text-teal-600 bg-teal-50 px-2 py-0.5 rounded-full">Win Coins</span>
          </button>
          ...
          <button onClick={() => window.location.href = 'https://about.barodamart.com'} className="w-full flex items-center justify-between px-3 py-3 hover:bg-neutral-50 transition-colors">
            <div className="flex items-center gap-3">
