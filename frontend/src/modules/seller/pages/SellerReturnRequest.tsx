                ...
                <div className="bg-white rounded-lg shadow-sm border border-neutral-200 flex flex-col">
                    ...
                    <div className="p-4 flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4 border-b border-neutral-100">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3 flex-1">
                            <div className="flex flex-col xl:flex-row items-start xl:items-center gap-2 w-full">
                                ...
                                <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
                                    <input
                                        ...
                                        className="px-3 py-2 bg-white border border-neutral-300 rounded text-sm focus:ring-1 focus:ring-green-500 focus:outline-none w-full sm:w-[130px]"
                                    />
                                    <input
                                        type="date"
                                        value={toDate}
                                    ...
                                    <button
                                        ...
                                        className="px-3 py-2 bg-neutral-700 hover:bg-neutral-800 text-white text-sm rounded transition-colors w-full sm:w-auto"
                                    >
                                        Clear
                                    </button>
                                </div>
